...
<body>
    ...
    <section id="house-specs" class="house-specs">
        <div class="specs-container">
            <h4>Alojamiento entero: loft en Calafat, España
            </h4>
            ...
            <div class="specs">
                ...
                <div class="individual-spec">
                    ...
                    <p>Patio trasero privado: Con valla en todo el perímetro</p>
                </div>
                <div class="separator-spec"></div>
                ...
                <div class="individual-spec">
                    ...
                    <p>Aparcamiento gratuito en las instalaciones</p>
                </div>
                <div class="separator-spec"></div>
        ...
        <div id="datePickDiv">
            <div id="fixedCalendar">
                ...
                <div id="dateSelector">
                    <div id="priceNight">
                        <b id="weekNightPrice">Seleccionar semana</b>
                    </div>
